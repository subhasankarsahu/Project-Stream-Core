...
const dashboardNavigation = [["Overview", "/studio", LayoutDashboard], ["Content", "/studio/content", Clapperboard], ["Analytics", "/studio/analytics", BarChart3], ["Settings", "/studio/settings", Settings]]
