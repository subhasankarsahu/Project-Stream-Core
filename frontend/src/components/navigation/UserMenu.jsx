...
export function UserMenu() {
  ...
  return <div className="relative">
    ...
    {open && <div className="absolute right-0 top-12 z-30 w-60 rounded-lg border border-line bg-surface p-2 shadow-2xl" role="menu">
      ...
      <Link onClick={() => setOpen(false)} to="/profile" className="mt-2 flex items-center gap-3 rounded-md px-3 py-2 text-sm text-muted hover:bg-line hover:text-white" role="menuitem"><UserRound size={16} /> Your profile</Link>
